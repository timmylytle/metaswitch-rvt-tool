...
public class rvt_grp_verify
{
    ...
    public static void main(String[] args) 
    {
        ...
        rvt_grp_verify verify = new rvt_grp_verify(emsAddress, userName, password, igrpnum);
        verify.execute();
   ...
   public rvt_grp_verify(String emsAddress, String userName, String password, int igrpnum)
    {
    ...
    public synchronized void execute() 
    {
        try
        { 
          File file = new File("rvt_grp_verify_output_grp_" + mGrpNum + ".csv");
